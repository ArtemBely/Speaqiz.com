  ...
  render() {
    return (
      <p className="forma">
        ...
        {this.er()}
        {this.er2()}
        <img src={self} id="selfy"/>
        <form action="registration/signin" method="POST" className="hey1">
        ...
        <p className="hrr"></p>
        <p className="c_name"><a href="/" className="linka">COMPANY NAME</a></p>
        <p className="privacy">Privacy data is protected by encryption &nbsp; © 2020</p>
        <p className="think" id="th">think</p><em className="think" id="ink">before</em><img src ={sky} className="sky_2"/>
      </p>
    )
  }
}
